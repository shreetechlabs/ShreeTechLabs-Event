...
<head>
  ...
  <meta name="description"
    content="ShreeTechLabs-Contest: The place where, you will get all the information about Hackathons, Workshops, Exhibitions & Technical Events that are going on near by your's location">
  ...
  <!-- page's title -->
  <title>ShreeTechLabs-Event | Don't miss any updates regarding Hackathons, Workshops, Exhibitions & Technical events
  </title>
...
<body>
  ...
  <!-- intro-section -->
  <div id="section-1">
    <div id="color-transparency">
      <div class="row">
        <div class="col-md-10">
          <span id="banner-text-1">Don't Miss Any</span>
          <span id="banner-text-2">Hackathons, Technical Events</span>
  ...
  </div><!-- section-5 for featured Exhibitions end-->
